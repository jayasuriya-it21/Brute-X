...
wordlist_file_path = "E:\\OneDrive - bitsathy.ac.in\\Documents\\BIT - Hack\\bruteforce\\wordlist.txt"  #input(f"{Fore.BLUE}Enter the path to the wordlist file: {Style.RESET_ALL}")
